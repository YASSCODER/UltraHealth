 ...
 */
final class Version20230221204046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD image VARCHAR(255) DEFAULT NULL, CHANGE author_id author_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP image, CHANGE author_id author_id INT DEFAULT NULL');
